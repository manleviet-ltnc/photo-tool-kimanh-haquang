...
namespace MyAlbumEditor
{
    public partial class EditorForm : Form
    {
        ...
        {
            cboAlbums.DataSource = Directory.GetFiles(AlbumManager.DefaultPath, "*.abm");
            OpenAlbum(cboAlbums.Text);
            base.OnLoad(e);
        }
        ...
        private void cboAlbums_SelectionChangeCommitted(object sender, EventArgs e)
        {
            string path = cboAlbums.Text;
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            using (FolderBrowserDialog dlg = new FolderBrowserDialog())
            {
                ...
                if (dlg.ShowDialog() == DialogResult.OK)
                {
                    ...
                    cboAlbums.Text = null;
                    cboAlbums.DataSource = Directory.GetFiles(dlg.SelectedPath, "*.abm");
                    OpenAlbum(cboAlbums.Text);
                }
            }
        }
        ...
        private void tabPhotos_SelectedIndexChanged(object sender, EventArgs e)
        {
            UpdateTabs();
        }
        ...
        private void UpdateTabs()
        {
            ...
            tabPhotos.Enabled = !nullManager;

            if (tabPhotos.SelectedTab == pagePhotos)
                DisplayAlbum();
            else if (tabPhotos.SelectedTab == pageDates)
                albCalendar.Manager = Manager;
            else if (tabPhotos.SelectedTab == pageImages)
